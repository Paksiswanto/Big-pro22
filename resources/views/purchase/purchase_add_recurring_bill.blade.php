...
<head>
    ...
    <!-- Title -->
    <title>Unknown | Tambah-Tagihan Berulang</title>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <h3>Tambah Tagihan Rutin<button type="button"
...
<!--  -->                                                  <div class="field-wrapper m-0">
                                    ...
                                    <div class="" style="margin-top: 2%;">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"
                                            ...
                                            <div style="border-bottom: solid grey 1px;">
                                                <h6>Jadwal</h6>
                                                <p>Pilih persyaratan dan waktu mulai/berakhir untuk memastikan bahwa
                                                    pelanggan menerima faktur Anda pada hari yang tepat.</p>
                                            </div>
                                        ...
                                        <h2 class="accordion-header" id="headingTwo">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                <div class="accordion-heading">
                                                    ...
                                                    <p class="accordion-description">Pilih kategori, tambahkan, atau
                                                        edit footer, dan tambahkan lampiran ke invoice-recurring.</p>
                                                </div>
                                            </button>
                                        </h2>
                                        <div id="collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="d-flex row">
                                                    <div class="col-4">
                                                        <div
                                                            class="flex-grow-0 col-xl-4 col-lg-4 col-md-4 col-sm-12 col-8">
                                                            <div id="dropzone"
                                                                style="width: 300px; height:300px; margin-top: 1%">
                                                                <label for="subjudul"
                                                                    class="field-label">Lampiran</label>
                                                                <form action="https://www.kodingwife.com/upload"
                                                                    class="dropzone needsclick dz-clickable"
                                                                    id="demo-upload" style="margin-right: 10%">
                                                                    <div class="dz-message needsclick">
                                                                        <button type="button" class="dz-button">Pilih
                                                                            berkas di sini untuk
                                                                            mengunggah.</button><br>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-8">
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-grow-1 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-8"
      ...
      <td>
        <div id="pajak-wrapper">
          <div class="field-wrapper mb-1 pajak-input-wrapper">
            <input type="number" name="pajak[]" style="border-radius:10px" class="form-control">
          </div>
