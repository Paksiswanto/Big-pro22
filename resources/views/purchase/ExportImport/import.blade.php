        ...
        <div class="main-container">
            ...
            <div class="content-wrapper-scroll">
                ...
                <div class="content-wrapper">
                    ...
                    <!-- Row start -->
                    <form action="{{ route('ImportDataSupplier') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="card">
                            ...
                            <div class="row mt-4">
                                <div class="alert2 alert-light2" role="alert">
                                    <p class="font-2">Anda dapat <a href="/DownloadSupplier"><strong class="font-s"> mengunduh</strong></a> berkas contoh dan lengkapi itu dengan data Anda.</p>
                                </div>
                            </div>
                        </div>
                            <div class="drop-zone">
