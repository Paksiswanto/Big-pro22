        ...
        <div class="main-container">
            ...
            <div class="content-wrapper-scroll">
                ...
                <div class="content-wrapper">
                    ...
                    <!-- Row start -->
                    <form action="{{ route('ImportDataCategory') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row gutters">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">
                                    <h1 class="card-title col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="font-size: 20px;">Import Ketegori</h1>
                                </div>
                            </div>
                            <!-- start -->
                            <div class="row mt-4">
                            ...
                            <div class="row mt-4">
                                <div class="alert2 alert-light2" role="alert">
                                    <p class="font-2">Anda dapat <a href="/DownloadCategory"><strong class="font-s"> mengunduh</strong></a> berkas contoh dan lengkapi itu dengan data Anda.</p>
                                </div>
                            </div>
                        </div>
                            <div class="drop-zone">
