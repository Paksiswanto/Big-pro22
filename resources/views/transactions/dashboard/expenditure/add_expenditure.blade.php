                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="" style="">
                                        ...
                                        <div class="">
                                            ...
                                            <!-- Row start -->
                                            <form action="/insert_expenditure" method="POST">
                                                @csrf
                                            <div class="row gutters">
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <!-- Field wrapper start -->
                                                    <div class="field-wrapper">
                                                        <textarea class="form-control1" rows="2" placeholder="Lampiran Tidak Wajib Diisi" name="attachment" id="attachment"></textarea>
