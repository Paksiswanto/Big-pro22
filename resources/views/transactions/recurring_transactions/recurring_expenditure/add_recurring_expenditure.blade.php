                                ...
                                <div class="" style="">
                                    <div class="row">
                                        <div class="card-title">
                                            <h3>Tambah Pengeluaran Rutin<button type="button" style="border: none; background:none;">☆</button></h3>
                                        </div>
                                    </div>
                                    <div class="">

                                        <!-- Row start -->
                                        <form action="/insert_recurring_expenditure" method="post">
                                            @csrf
                                            <div class="row gutters">
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    ...
                                                    <div class="field-wrapper">
                                                        <div class="input-group">
                                                            <input type="text" style="z-index:auto" class="form-control" placeholder="Dihasilkan Secara Otomatis" name="date" disabled>
                                                    ...
                                                    <div class="field-wrapper-group">
                                                        <div class="field-wrapper">
                                                            <select class="select-multiple js-states" title="Select Product Category" name="payment_method" id="payment_method" style="font-size: 5px;">
                                                                ...
                                                                <option value="Transfer Bank" {{ old('payment_method') === 'TransferBank ' ? 'selected' : '' }}>Transfer Bank</option>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    ...
                                                    <!-- Field wrapper start -->
                                                    <div class="field-wrapper">
                                                        <input class="form-control" type="number" placeholder="Rp0,00" name="entry_amount" id="entrty_amount">
                                                    ...
                                                    <div class="field-wrapper-group">
                                                        <div class="field-wrapper" style="display: flex; flex-direction: row;">
                                                            ...
                                                            <div id="customInput" class="col-2" style="display: none; margin-left: 10px;">
                                                                <input type="text" class="" placeholder="Masukan" name="repeat2">
                                                            </div>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    ...
                                                    <!-- Field wrapper start -->
                                                    <div class="field-wrapper">
                                                        <input class="form-control" type="text" placeholder="Dihasilkan Secara Otomatis" name="number" disabled>
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <!-- Field wrapper start -->
                                                    <div class="field-wrapper">
                                                        <textarea class="form-control1" rows="2" placeholder="Lampiran Tidak Wajib Diisi" name="attacment"></textarea>
