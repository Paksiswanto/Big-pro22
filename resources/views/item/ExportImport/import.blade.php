        ...
        <div class="main-container">
            ...
            <div class="content-wrapper-scroll">
                ...
                <div class="content-wrapper">
                    ...
                    <!-- Row start -->
                    <form action="{{ route('ImportDataItem') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="card">
                            ...
                            <div class="row mt-4">
                                <div class="alert3 alert-light3" role="alert">
                                    ...
                                    <p class="font-3">category_id yang tersedia untuk inputkan : 
                                    ...
                                    <p class="font-3">tax_id yang tersedia untuk inputkan : 
                                        @foreach ($tax as $index => $taxs)
                                            {{ $taxs->name }}
                                            @if ($index != count($tax) - 1)
                                                ,
                                            @endif
                                        @endforeach
                                    </p>
                            ...
                            <div class="row mt-4">
                                <div class="alert2 alert-light2" role="alert">
                                    <p class="font-2">Anda dapat <a href="/DownloadItem"><strong class="font-s"> mengunduh</strong></a> berkas contoh dan lengkapi itu dengan data Anda.</p>
                                </div>
                            </div>
                        </div>
                            <div class="drop-zone">
                                <span class="drop-zone__prompt">Jatuhkan file atau klik untuk mengunggah</span>
                                <input type="file" name="myFile" class="drop-zone__input" onchange="displayFileName()" />
                                <p id="file-name"></p>
                            </div>
		...
		************* -->
        ...
        <script>
            function displayFileName() {
                ...
                document.getElementById("file-name").innerHTML = "File yang dipilih: " + fileName;
            }
        </script>
</body>
