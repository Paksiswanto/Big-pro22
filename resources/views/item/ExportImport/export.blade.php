    ...
    <table class="daftar" width="986">
        <thead>
            <tr>
                ...
                <th style="width: 120px;">category_id</th>
                <th style="width: 120px;">selling_price</th>
                <th style="width: 120px;">purchase_price</th>
                <th style="width: 100px;">tax_id</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->active }}</td>
                <td>{{ $item->type}}</td> <!-- Menampilkan nama type -->
                <td>{{ $item->category->name }}</td> <!-- Menampilkan nama category -->
                <td>{{ $item->selling_price }}</td>
                <td>{{ $item->purchase_price }}</td>
                <td>{{ $item->tax->name }}</td> <!-- Menampilkan nama tax -->
                <td>{{ $item->company->name }}</td> <!-- Menampilkan nama company -->
            </tr>
            @endforeach
        </tbody>
    </table>
